---
title: "Tidy XGB markup"
author: "Cliff Kintanar"
date: "12/11/2018"
output: pdf_document
---
...
```{r, echo=FALSE}
bbalance <- read_csv("./inputs/bureau_balance.csv") 
bureau <- read_csv("./inputs/bureau.csv")
cc_balance <- read_csv("./inputs/credit_card_balance.csv")
payments <- read_csv("./inputs/installments_payments.csv") 
pc_balance <- read_csv("./inputs/POS_CASH_balance.csv")
prev <- read_csv("./inputs/previous_application.csv")
tr <- read_csv("./inputs/application_train.csv") 
te <- read_csv("./inputs/application_test.csv")
```
